        ...
        <div class="card custom-card">
            ...
            <div class="card-body pt-0 px-0">
                ...
                <div class="mx-3 mt-3 mb-2"><button type="button" class="btn btn-danger btn-block"
                        @click="showModal = true"><small>BUILD & PRICE</small></button></div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Rent confirmation</h5>
            <button type="button" class="close" @click="showModal = false">
              <span>&times;</span>
            </button>
          </div>
          <div class="modal-body">
            Are you sure you want to book this vehicle? This will appear on your profile page and decrease available stock.
          </div>
